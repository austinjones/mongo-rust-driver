...
impl Bsonc {
    ...
    pub fn new() -> Bsonc {
        let inner: *const bindings::bson_t =
            unsafe { bindings::bson_sized_new(128usize as libc::c_ulong) };
    ...
    pub fn from_document(document: &bson::Document) -> Result<Bsonc> {
        ...
        let inner = unsafe {
            bindings::bson_new_from_data(buffer[..].as_ptr(), buffer.len() as libc::c_ulong)
        };
